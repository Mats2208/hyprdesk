...
export function ActivityBar() {
  ...
  return (
    <div className="activitybar">
      <button className={`act ${on("workspaces")}`} title="Workspaces" onClick={() => openPanel("workspaces")}>
      ...
      <button className={`act ${on("agents")}`} title="Agentes (⌘B)" onClick={() => openPanel("agents")}>
      ...
      <button className={`act ${on("files")}`} title="Archivos" onClick={() => openPanel("files")}>
      ...
      <button className={`act ${on("changes")}`} title="Cambios" onClick={() => openPanel("changes")}>
